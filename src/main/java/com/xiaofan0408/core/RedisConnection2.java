...
import com.xiaofan0408.codec.RedisPacketEncoder;
...
public class RedisConnection2 implements AbstractConnection{

    private static final Logger logger = Loggers.getLogger(RedisConnection2.class);
    ...
    public RedisConnection2(Connection connection) {
